...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		{
			model = glm::mat4(1.0);
			model = glm::translate(model, glm::vec3(0.0f, 0.0f, -1.5f + mainWindow.getmuevex()));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			Kitt_M.RenderModel();
			modelaux = model;
		...
		*/
		...
		spotLights[1].SetPos(glm::vec3(model[3][0], model[3][1], model[3][2]));
		...
		spotLights[0].SetPos(glm::vec3(model[3][0], model[3][1], model[3][2] + 0.2f));
